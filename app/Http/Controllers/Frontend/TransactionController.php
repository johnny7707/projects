...
class TransactionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.transactions.create', compact('projects', 'transaction_types', 'income_sources', 'currencies'));
    }
    ...
    public function edit(Transaction $transaction)
    {
        ...
        return view('frontend.transactions.edit', compact('projects', 'transaction_types', 'income_sources', 'currencies', 'transaction'));
    }
