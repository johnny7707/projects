                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.lessons.update", [$lesson->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="long_text" id="long_text">{{ old('long_text', $lesson->long_text) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_free" id="is_free" value="1" {{ $lesson->is_free || old('is_free', 0) === 1 ? 'checked' : '' }}>
